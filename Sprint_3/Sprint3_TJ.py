...
=============================================================================
 ...
 |     Due Date:  Sunday (07/22/2018) 10pm
 |     Language:  Python
 | Ex. Packages:  N/A
 | Deficiencies:  None
 ===========================================================================
...
class Repository:
    ...
    def list_all_deceased(self):
        ...
        result = []
        for key, individual in self.individual.items():
            if not individual.isAlive:
                result.append(individual)
        if result.count > 0:
            print ("US 29: " +result.count + " individuals are deceased in the given file")
        else:
            print ("US 29:No deceased individuals exist in the given file")
        return result
...
class Test(unittest.TestCase):
    ...
    def test_list_all_deceased(self):
        ...
        repo = Repository()
        repo.read_file(path)
        self.assertEqual(repo.list_all_deceased().count, 1)
        self.assertNotEqual(repo.list_all_deceased().count, 10)
        self.assertTrue(repo.list_all_deceased().count > 0)
